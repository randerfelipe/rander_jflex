...
// source: src/main/jflex/exemplo4.jflex
...
class Lexico {
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\0\2\2\1\3\1\4\1\5\1\6\11\0\1\2"+
    "\10\0\2\5\5\0\3\6";
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 4: break;
          case 2:
            { return new Token(yyline + 1, yycolumn + 1, Classe.cInt, new Valor(yytext()));
            }
          // fall through
          case 5: break;
          case 3:
            { return new Token(yyline + 1, yycolumn + 1, Classe.cIdent, new Valor(yytext()));
            }
          // fall through
          case 6: break;
          default:
